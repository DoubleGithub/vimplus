...
set runtimepath+=$VIM/.vim/autoload/plug.vim
...
" 查看help文件
nnoremap <leader>h :edit $VIM/.vim/help.md<cr>
...
inoremap <leader>n <esc> :exec("NERDTreeToggle ".expand('%:h'))<CR>
...
" pydiction
"let g:pydiction_location='$VIM/.vim/plugged/pydiction/complete-dict'
...
"let g:ycm_python_binary_path  = 'c:/MySoftWare/Python36/python'
" let g:ycm_python_binary_path  = 'd:/WorkSpace/Wing/Hnu_xshd/venv/Scripts/python'
"let g:ycm_python_binary_path  = 'c:/MySoftWare/Anaconda3/python'
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

"""""""YCM 配置"""""""""""""""""""""""""
"let g:ycm_server_python_interpreter='c:/MySoftWare/Python27/python'
let g:ycm_global_ycm_extra_conf = '$VIM/.vim/.ycm_extra_conf.py'
"设置不显示错误信息
...
map <F6> :call Setfilehead()<CR>:10<CR>i
"###################    set file head end   ##########################
